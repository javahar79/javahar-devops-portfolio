...
- [Git & Version Control Primer](../docs/concepts/git-version-control/0000-primer-git-version-control.md) — Repository, commit, branch, and remote fundamentals. The backbone of every modern DevOps workflow.
- [Scripting & Automation Primer](../docs/concepts/scripting-automation/0000-primer-scripting-automation.md) — Scripts, cron, idempotency, and automation patterns. The difference between doing things once and doing them forever.
...
- [Git Reflog & Rebase Cleanup (2026-07-20)](../git/scripts/2026-07-20-git-reflog-rebase.sh) — Interactive rebase and history cleanup.
- [Git Branching, Merging, and Conflicts (2026-07-22)](../docs/concepts/git-version-control/scripts/2026-07-22-git-branching-merging-conflicts.sh) — Hands-on practice resolving merge conflicts.
...
- [K8s Quickstart — What Tripped Me Up (2026-07-10)](../kubernetes/notes/2026-07-10-k8s-quickstart-trials.md) — kind vs minikube gotchas, pod creation, and probes.
...
Stage 1 → Stage 2 → Stage 3 → Stage 4 → Stage 5
    ...
    (CI/CD,    →  Tools    → CLI Notes  → K8s     → Terraform
     ...
     Network,    Terraform,                ↓
     Git,        GitHub     → K8s Debug
    Scripting)   Actions)    (describe,
          ↓                   logs,
     Primes               events)
```

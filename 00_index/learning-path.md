...
- [CI/CD Workflow Overview (2026-07-19)](../docs/concepts/ci-cd-concepts/2026-07-19-ci-cd-workflow-overview.md) — A walk through the CI/CD pieces already in this portfolio.
...
- [Git Quickstart Trials (2026-07-19)](../git/notes/2026-07-19-git-quickstart-trials.md) — Latest first-contact gotchas.
- [Git Undo/Stage/Commit/Push (2026-07-19)](../git/notes/2026-07-19-git-undo-stage-commit-push.md) — Latest undo and fixup patterns.
...
- [Docker Quickstart — What Tripped Me Up (2026-07-18)](../docker/notes/2026-07-18-docker-quickstart-tripped-me.md) — Newest quickstart notes with port mapping, volume, and debugging gotchas.
...
- [Minimal CI Workflow (2026-07-19)](../github-actions/configs/2026-07-19-minimal-ci-workflow.yaml) — Latest GitHub Actions CI workflow config.
...
- [Reading Workflow Logs and Debugging (2026-07-19)](../github-actions/docs/2026-07-19-reading-workflow-logs-and-debugging.md) — Latest debugging walkthrough for GHA failures.
- [Reading Workflow Logs and Debugging (2026-07-10)](../github-actions/docs/2026-07-10-reading-workflow-logs-and-debugging.md) — Log reading and debugging patterns.
- [Terraform Version & Init (2026-07-19)](../terraform/notes/2026-07-19-terraform-version-init.md) — Latest Terraform version check, init, and walkthrough.
- [Terraform Directoy Structure (2026-07-19)](../terraform/notes/2026-07-19-terraform-directory-structure.md) — Terraform project layout notes.
- [Install Terraform and Run Version (2026-07-19)](../terraform/notes/2026-07-19-install-terraform-and-run-version.md) — Latest Terraform CLI install walkthrough.
...
- [First Local File Resource (2026-07-19)](../terraform/configs/2026-07-19-first-local-file-resource.hcl) — Latest Terraform local_file resource config.
...
- [Inspecting Pods, Services, and Events (2026-07-19)](../kubernetes/docs/2026-07-19-inspecting-pods-services-events.md) — Latest kubectl debugging patterns.

...
### Automate with CI/CD
- [Minimal CI Workflow (2026-07-10)](../github-actions/configs/2026-07-10-minimal-ci-workflow.yaml) — CI with job dependencies and trigger filtering
...
- [GHA Quickstart — Round Two](../github-actions/notes/2026-07-10-gha-quickstart-trials.md) — Triggers, env vars, secrets, and path filtering
...
- [Git Branch/Merge/Revert Workflow](../git/scripts/2026-07-10-branch-merge-revert-workflow.sh) — Practice fast-forward, three-way, conflict, and revert

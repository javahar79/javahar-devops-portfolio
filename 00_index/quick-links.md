...
- [Docker Quickstart Notes (2026-07-08)](../docker/notes/2026-07-08-docker-quickstart-trials.md) — localhost vs service name, port conflicts, .dockerignore, and latest tag gotchas
- [Tagged Build Non-Root Dockerfile (2026-07-08)](../docker/dockerfiles/2026-07-08-tagged-nonroot.Dockerfile) — Multi-stage Python build with pinned tag and non-root runtime
...
- [Docker Quickstart Notes (2026-07-09)](../docker/notes/2026-07-09-docker-quickstart-trials.md) — Tagged build, Alpine flags, port conflicts, and self-contained HTTP server
- [Tagged Build Non-Root Dockerfile (2026-07-09)](../docker/dockerfiles/2026-07-09-tagged-nonroot.Dockerfile) — Single-stage Python HTTP server with pinned tag and non-root user
- [Port Map Script (2026-07-09)](../docker/scripts/2026-07-09-run-container-port-map.sh) — Build and run Python HTTP server with port 8082 mapping

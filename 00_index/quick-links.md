...
- [Tagged Build Dockerfile (2026-07-09)](../docker/dockerfiles/2026-07-09-tagged-nonroot.Dockerfile) — Minimal Alpine multi-stage build with pinned tag and non-root runtime
...
- [Kubernetes Quickstart Trials (2026-07-10)](../kubernetes/notes/2026-07-10-k8s-quickstart-trials.md) — Official K8s quickstart gotchas and lessons learned
- [Install Local Cluster](../kubernetes/scripts/install-local-cluster.sh) — Set up kind for local development

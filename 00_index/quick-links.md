...
- [Docker Quickstart Notes](../docker/notes/2026-06-25-docker-quickstart-trials.md) — What tripped me up in the quickstart
- [Minimal Non-Root Dockerfile](../docker/dockerfiles/2026-06-25-minimal-nonroot.Dockerfile) — Tagged build with non-root user
- [Port Map First Container Script](../docker/scripts/2026-06-25-first-container-port-map.sh) — Run nginx and verify port mapping
